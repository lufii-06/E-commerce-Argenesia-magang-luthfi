                ...
                <div class="card" style="width: 26rem;">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6 text-left"> Akun anda masi belum diverifikasi oleh Fi Store
                                Dengan alasan
                                <textarea name="" class="form-control" readonly style="height: 100px; overflow-y: auto; resize: none;" id="" cols="30" rows="10">{{ $pesan->pesan }}
                                </textarea>
                        </div>
                        <div class="row mt-5">
                            <div class="col-md-8 offset-md-4 text-right">
                                <a class="btn btn-primary" href="{{ route('toko.perbaiki',$toko->id) }}">Perbaiki
                                </a>
